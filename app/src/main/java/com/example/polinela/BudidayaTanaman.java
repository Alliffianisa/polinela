...
public class BudidayaTanaman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_budidaya_tanaman);
...
//        jika di klik salah satu prodi tampilkan activity detail prodi
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View container,
                ...
                if (position == 1) {
                    Intent myIntent = new Intent(container.getContext(), Tanaman_pangan.class);
                    startActivityForResult(myIntent, 0);
                }
                if (position == 2) {
                    Intent myIntent = new Intent(container.getContext(), Teknologi_perbenihan.class);
                    startActivityForResult(myIntent, 0);
                }

                if (position == 3) {
                    Intent myIntent = new Intent(container.getContext(), Tanaman_hortikultura.class);
                    startActivityForResult(myIntent, 0);
                }
