...
//        jika di klik salah satu prodi tampilkan activity detail prodi
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View container,
                ...
                if (position == 0) {
                    Intent myIntent = new Intent(container.getContext(), Teknologi_produksi_ternak.class);
                    startActivityForResult(myIntent, 0);
                }

                if (position == 1) {
                    Intent myIntent = new Intent(container.getContext(), Teknologi_pembenihan_ikan.class);
                    startActivityForResult(myIntent, 0);
                }
                if (position == 2) {
                    Intent myIntent = new Intent(container.getContext(), Produksi_ternak.class);
                    startActivityForResult(myIntent, 0);
                }

                if (position == 3) {
                    Intent myIntent = new Intent(container.getContext(), Budidaya_perikanan.class);
                    startActivityForResult(myIntent, 0);
                }
                if (position == 4) {
                    Intent myIntent = new Intent(container.getContext(), Perikanan_tangkap.class);
                    startActivityForResult(myIntent, 0);
                }
            }
        };
