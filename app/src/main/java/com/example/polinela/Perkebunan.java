...
public class Perkebunan extends AppCompatActivity {
...
//        jika di klik salah satu prodi tampilkan activity detail prodi
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View container,
                ...
                if (position == 0) {
                    Intent myIntent = new Intent(container.getContext(), Produksi_tanaman_perkebunan.class);
                    startActivityForResult(myIntent, 0);
                }

                if (position == 1) {
                    Intent myIntent = new Intent(container.getContext(), Produksi_manajemen_industri_perkebunan.class);
                    startActivityForResult(myIntent, 0);
                }
                if (position == 2) {
                    Intent myIntent = new Intent(container.getContext(), Perkebunan_kopi.class);
                    startActivityForResult(myIntent, 0);
                }
            }
        };
